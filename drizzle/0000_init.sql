...
CREATE TABLE "hx2-audience_activity" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "hx2-audience_activity_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "hx2-audience_activity_response" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "hx2-audience_activity_response_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "hx2-audience_event" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "hx2-audience_event_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"shortId" varchar(6),
...
--> statement-breakpoint
CREATE TABLE "hx2-audience_post" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "hx2-audience_post_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256),
...
CREATE TABLE "hx2-audience_question" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "hx2-audience_question_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"eventId" integer NOT NULL,
...
ALTER TABLE "hx2-audience_post" ADD CONSTRAINT "hx2-audience_post_createdById_hx2-audience_user_id_fk" FOREIGN KEY ("createdById") REFERENCES "public"."hx2-audience_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "created_by_idx" ON "hx2-audience_post" USING btree ("createdById");--> statement-breakpoint
CREATE INDEX "name_idx" ON "hx2-audience_post" USING btree ("name");--> statement-breakpoint
